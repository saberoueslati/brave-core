...
public class BraveUnifiedPanelHandler {
    ...
    private void updateValues() {
        ...
        if (favicon != null) {
            ...
            int shieldIconRes =
                    isShieldsUp
                            ? R.drawable.ic_unified_shields_enabled
                            : R.drawable.ic_unified_shields_disabled;
            mShieldIconUnified.setImageResource(shieldIconRes);
        }
    ...
    private void setupReportBrokenSitePanel() {
        ...
        if (siteFavicon != null && mCurrentTab != null) {
            ...
            if (tabFavicon != null) {
                ...
                siteFavicon.setImageResource(R.drawable.ic_globe_24dp);
            }
        }
    ...
    private void submitBrokenSiteReport() {
        ...
        reportInfo.reportUrl = mUrl.getSpec();
    ...
    private void addBlockOverlay(FrameLayout container, int iconSize) {
        ...
        overlay.setImageResource(R.drawable.ic_blocked_item_overlay);
